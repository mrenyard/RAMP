...
/**
 * Strictly alphabetic Regex pattern validation, allows ONLY
 * uppercase and lowercase latin characters.
 */
class AlphabeticStrict extends RegexValidationRule
{
    /**
   * Constructor for strict alphabetic Regex pattern validation.
  ...
  {
    parent::__construct($errorHint, '[a-zA-Z]*', $subRule);
  }
}
