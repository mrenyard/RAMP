 ...
 * - Define and restrict relational association to objects of this type ({@see \ramp\model\business\Relatable}). 
 * - Provide methods to maintain and access a Collection of {@see Record}s
 *
 * COLLABORATORS
 * - Collection of {@see \ramp\model\business\Record}s
 */
class RecordCollection extends Relatable implements iCollection
{
   ...
   *  - e.g. {@see \ramp\model\business\UserCollection} would expect to referance only {@see \ramp\model\business\User}s.
   */
