...
/**
 * URN Query environment, containing specialised operator strings as defined in iEnvironment.
 *
 * RESPONSIBILITIES
 * - Define full set of URN Query environment specialised operators
 */
