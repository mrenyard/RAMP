...
class RequestTest extends \PHPUnit\Framework\TestCase {
  ...
  public function testGETRecordCollection()
  {
    ...
    $this->assertInstanceOf('svelte\core\Str', $testObject->getRecordName());
    $this->assertEquals('MockRecord', (string)$testObject->getRecordName());
  ...
  public function testPOSTRecord()
  {
    ...
    $this->assertInstanceOf('svelte\core\Str', $testObject->getRecordName());
    $this->assertEquals('MockRecord', (string)$testObject->getRecordName());
    $this->assertInstanceOf('svelte\core\Str', $testObject->getRecordKey());
    $this->assertEquals('key', (string)$testObject->getRecordKey());
    $this->assertNull($testObject->getPropertyName());
    $this->assertInstanceOf('svelte\core\Str', $testObject->resourceIdentifier);
    $this->assertEquals('/mock-record/~/', (string)$testObject->resourceIdentifier);
    $this->assertInternalType('int', $testObject->fromIndex);
  ...
  public function test_POSTProperty()
  {
    ...
    $this->assertInstanceOf('svelte\core\Str', $testObject->getRecordKey());
    $this->assertEquals('key', (string)$testObject->getRecordKey());
    $this->assertInstanceOf('svelte\core\Str', $testObject->getPropertyName());
    $this->assertEquals('propertyB', (string)$testObject->getPropertyName());
    $this->assertInstanceOf('svelte\core\Str', $testObject->resourceIdentifier);
