 ...
 * .
 */
class URNQueryEnvironmentTest extends \tests\ramp\condition\EnvironmentTest
{
  #region Setup
  protected function preSetup() : void {
    $this->instance = URNQueryEnvironment::getInstance();
    $this->className = 'ramp\condition\URNQueryEnvironment';
  }
  protected function getTestObject() : RAMPObject { return URNQueryEnvironment::getInstance(); }
  #endregion
  ...
  public function testConstruct() : void
  {
    try {
      ...
      $this->assertInstanceOf('\ramp\condition\URNQueryEnvironment', $this->testObject);
      return;
    }
   ...
   */
  public function testNotEqualTo($expectedOutput = '|not=') : void
  {
   ...
   */
  public function testLessThan($expectedOutput = '|lt=') : void
  {
   ...
   */
  public function testGreaterThan($expectedOutput = '|gt=') : void
  {
