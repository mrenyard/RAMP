...
class URNQueryEnvironmentTest extends \PHPUnit\Framework\TestCase
{
  ...
  public function testAssignment()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->assignment is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testEqualTo()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->equalTo is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testNotEqualTo()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->notEqualTo is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testLessThan()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->lessThan is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testGreaterThan()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->greaterThan is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testAnd()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->and is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testOr()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->or is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testOpeningParenthesis()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->openingParenthesis is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testClosingParenthesis()
  {
    try {
      ...
      $this->assertSame(
        'ramp\condition\URNQueryEnvironment->closingParenthesis is NOT settable',
        $expected->getMessage()
      );
