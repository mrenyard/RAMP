 ...
 * .
 */
class URNQueryEnvironmentTest extends \PHPUnit\Framework\TestCase
{
  ...
  {
    try {
      $testObject = new URNQueryEnvironment();
      ...
      $this->assertSame(URNQueryEnvironment::getInstance(), $this->testInstance);
      return;
    }
  ...
  public function testAssignment()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->assignment is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testEqualTo()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->equalTo is NOT settable',
        $expected->getMessage()
      );
   ...
   * - assert retreved is an instance of {@link \svelte\core\Str}.
   * - assert retreved is same string as provided at construction (|not=).
  ...
  public function testNotEqualTo()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->notEqualTo is NOT settable',
        $expected->getMessage()
      );
      $this->assertInstanceOf('\svelte\core\Str', $this->testInstance->notEqualTo);
      $this->assertSame('|not=', (string)$this->testInstance->notEqualTo);
      return;
    }
    $this->fail('An expected \svelte\core\PropertyNotSetException has NOT been raised');
  }
   ...
   * - assert retreved is an instance of {@link \svelte\core\Str}.
   * - assert retreved is same string as provided at construction (|lt=).
  ...
  public function testLessThan()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->lessThan is NOT settable',
        $expected->getMessage()
      );
      $this->assertInstanceOf('\svelte\core\Str', $this->testInstance->lessThan);
      $this->assertSame('|lt=', (string)$this->testInstance->lessThan);
      return;
    }
    $this->fail('An expected \svelte\core\PropertyNotSetException has NOT been raised');
  }
   ...
   * - assert retreved is an instance of {@link \svelte\core\Str}.
   * - assert retreved is same string as provided at construction (|gt=).
  ...
  public function testGreaterThan()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->greaterThan is NOT settable',
        $expected->getMessage()
      );
      $this->assertInstanceOf('\svelte\core\Str', $this->testInstance->greaterThan);
      $this->assertSame('|gt=', (string)$this->testInstance->greaterThan);
      return;
    }
    $this->fail('An expected \svelte\core\PropertyNotSetException has NOT been raised');
  }
  ...
  public function testAnd()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->and is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testOr()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->or is NOT settable',
        $expected->getMessage()
      );
   ...
   * - assert retreved is an instance of {@link \svelte\core\Str}.
   * - assert retreved is same string as provided at construction (EMPTY).
  ...
  public function testOpeningParenthesis()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->openingParenthesis is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testClosingParenthesis()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\URNQueryEnvironment->closingParenthesis is NOT settable',
        $expected->getMessage()
      );
