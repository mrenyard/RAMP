...
use \svelte\condition\PHPEnvironment;
...
class PHPEnvironmentTest extends \PHPUnit\Framework\TestCase
{
  ...
  public function testAssignment()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->assignment is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testEqualTo()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->equalTo is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testNotEqualTo()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->notEqualTo is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testLessThan()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->lessThan is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testGreaterThan()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->greaterThan is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testAnd()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->and is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testOr()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->or is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testOpeningParenthesis()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->openingParenthesis is NOT settable',
        $expected->getMessage()
      );
  ...
  public function testClosingParenthesis()
  {
    try {
      ...
      $this->assertSame(
        'svelte\condition\PHPEnvironment->closingParenthesis is NOT settable',
        $expected->getMessage()
      );
