 ...
 * @version 0.0.9;
 */
namespace tests\svelte\condition\mocks\ConditionTest;

use svelte\condition\Condition;
use svelte\condition\iEnvironment;

/**
 * Concreate implementation of \svelte\condition\Condition for testing against.
 * .
 */
class ConcreteCondition extends Condition
{
  /**
