 ...
 */
class MockSqlBusinessModelManager extends BusinessModelManager
{
  ...
  public static function getInstance() : BusinessModelManager
  {
    if (!isset(self::$instance)) {
      self::$instance = new MockSqlBusinessModelManager();
    }
  ...
  private function buildObjectFour() {
    ...
    $this->objectFour = new MockMinRecord($this->dataObjectFour); //, TRUE);
  }
