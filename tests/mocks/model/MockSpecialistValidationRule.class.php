 ...
 */
class MockSpecialistValidationRule extends SpecialistValidationRule
{
  /**
  ...
  protected function test($value) : void
  {
    ...
    if ($value === 'BadValue') {
      throw new FailedValidationException('MockSpecialistValidationRule has been given the value BadValue');
    }
  }
}
