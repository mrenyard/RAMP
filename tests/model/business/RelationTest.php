...
class RelationTest extends \PHPUnit\Framework\TestCase
{
  ...
  public function test__construct()
  {
    ...
    $this->assertInstanceOf('\ramp\model\business\RecordComponent', $this->testObjectAlpha);
    $this->assertInstanceOf('\ramp\model\business\RecordComponent', $this->testObjectBeta);
    $this->assertInstanceOf('\ramp\model\business\Relation', $this->testObjectAlpha);
    $this->assertInstanceOf('\ramp\model\business\Relation', $this->testObjectBeta);
  }
  ...
  public function testGet_type()
  {
    try {
      ...
      try {
        ...
        $this->assertEquals('relation record-component', (string)$this->testObjectAlpha->type);
        $this->assertEquals('relation record-component', (string)$this->testObjectBeta->type);
        return;
      }
    }
    $this->fail('An expected \ramp\core\PropertyNotSetException has NOT been raised.');
  ...
  public function testGetIterator()
  {
    ...
    foreach ($this->testObjectBeta as $property) {
      $this->assertInstanceOf('\ramp\model\business\RecordComponent', $property);
  ...
  public function testOffsetGet()
  {
    try {
      ...
      try {
        ...
        $this->assertInstanceOf('\ramp\model\business\RecordComponent', $this->testObjectBeta[0]);
        ...
        $this->assertInstanceOf('\ramp\model\business\RecordComponent', $this->testObjectBeta[1]);
        ...
        $this->assertInstanceOf('\ramp\model\business\RecordComponent', $this->testObjectBeta[2]);
  ...
  public function testValidateRelationUnset()
  {
    ...
    $this->assertInstanceOf('\ramp\model\business\RecordComponent', $this->testObjectAlpha[0]);
