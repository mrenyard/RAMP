...
class SelectOneTest extends \PHPUnit\Framework\TestCase
{
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::__construct().
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::id.
   ...
   * @link ramp.model.business.field.SelectOne#method_get_id ramp\model\business\field\SelectOne::id
   */
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::type.
   ...
   * - assert returned value matches expected result.
   * @link ramp.model.business.field.SelectOne#method_get_type ramp\model\business\field\SelectOne::type
   */
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::getIterator().
   * - assert returns object that is an instance of {@link \Traversable}
   * - assert foreach loop, iterates through each expected object.
   * - assert foreach returned object matches expected.
   * @link ramp.model.business.field.SelectOne#method_getIterator ramp\model\business\field\SelectOne::getIterator()
   */
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::offsetGet.
   * - assert {@link \OutOfBoundsException} thrown when offset index beyond bounds of its children
   * - assert expected object returned at its expected index.
   * @link ramp.model.business.field.SelectOne#method_offsetGet ramp\model\business\field\SelectOne::offsetGet()
   */
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::offsetExists.
   * - assert True returned on isset() when within expected bounds.
   * - assert False returned on isset() when outside expected bounds.
   * @link ramp.model.business.field.SelectOne#method_offsetExists ramp\model\business\field\SelectOne::offsetExists()
   */
  ...
  /**
   * Collection of assertions for ramp\model\business\field\SelectOne::offsetSet().
   ...
   * @link ramp.model.business.field.SelectOne#method_offsetSet \ramp\model\business\field\SelectOne::offsetSet()
   */
  ...
  /**
   * Collection of assertions for \ramp\model\business\field\SelectOne::offsetUnset.
