...
require_once '/usr/share/php/ramp/model/business/validation/LowercaseAlphabetic.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockLowercaseAlphabetic.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\LowercaseAlphabetic;

use tests\ramp\mocks\model\MockLowercaseAlphabetic;
...
/**
 * Collection of tests for \ramp\model\business\validation\LowercaseAlphabetic.
 */
class LowercaseAlphabeticTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockLowercaseAlphabetic($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\LowercaseAlphabetic.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\LowercaseAlphabetic}
   * @see \ramp\model\business\validation\LowercaseAlphabetic
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\LowercaseAlphabetic', $this->testObject);
  }
