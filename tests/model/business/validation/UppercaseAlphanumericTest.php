...
require_once '/usr/share/php/ramp/model/business/validation/UppercaseAlphanumeric.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockUppercaseAlphanumeric.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\UppercaseAlphanumeric;

use tests\ramp\mocks\model\MockUppercaseAlphanumeric;
...
/**
 * Collection of tests for \ramp\model\business\validation\UppercaseAlphanumeric.
 */
class UppercaseAlphanumericTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockUppercaseAlphanumeric($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\UppercaseAlphanumeric.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\UppercaseAlphanumeric}
   * @see \ramp\model\business\validation\UppercaseAlphanumeric
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\UppercaseAlphanumeric', $this->testObject);
  }
  ...
  public function testExpectedAttributeValues()
  {
    ...
    $this->assertEquals('[0-9A-Z_\-\.\']*', (string)$this->testObject->pattern);
