...
require_once '/usr/share/php/svelte/model/business/validation/dbtype/DateTime.class.php';
...
use svelte\model\business\validation\dbtype\DateTime;

use tests\svelte\model\business\validation\FailOnBadValidationRule;

/**
 * Collection of tests for \svelte\model\business\validation\dbtype\DateTime.
 */
class DateTimeTest extends \PHPUnit\Framework\TestCase
{
  ...
  /**
   * Collection of assertions for svelte\validation\dbtype\DateTime::__construct().
   * - assert is instance of {@link \svelte\core\SvelteObject}
   * - assert is instance of {@link \svelte\model\business\validation\ValidationRule}
   * - assert is instance of {@link \svelte\model\business\validation\DateTime}
   * @link svelte.model.business.validation.dbtype.DateTime \svelte\model\business\validation\dbtype\DateTime
   */
  public function test__Construct()
  {
    ...
    $this->assertInstanceOf('svelte\model\business\validation\dbtype\DateTime', $this->testObject);
  }

  /**
   * Collection of assertions for svelte\model\business\validation\dbtype\DateTime::process().
   ...
   * @link svelte.model.business.validation.dbtype.DateTime#method_process \svelte\model\business\validation\dbtype\DateTime::process()
   */
  public function testTest()
  {
    $this->assertNull($this->testObject->process('2006-12-24T23:29:59'));
    try {
