...
require_once '/usr/share/php/ramp/model/business/validation/AlphanumericStrict.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockAlphanumericStrict.class.php';
...
use tests\ramp\mocks\model\MockAlphanumericStrict;
...
/**
 * Collection of tests for \ramp\model\business\validation\AlphanumericStrict.
 */
class AlphanumericStrictTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockAlphanumericStrict($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\AlphanumericStrict.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\AlphanumericStrict}
   * @see \ramp\model\business\validation\AlphanumericStrict
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\AlphanumericStrict', $this->testObject);
  }
  ...
  public function testExpectedAttributeValues()
  {
    ...
    $this->assertEquals('[a-zA-Z0-9]*', (string)$this->testObject->pattern);
  ...
  public function testProcess(
    array $badValues = ['bad.regex'], ?array $goodValues = ['g00R3g3x'], int $failPoint = 1, int $ruleCount = 6,
