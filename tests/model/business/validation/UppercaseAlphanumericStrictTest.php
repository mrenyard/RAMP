...
require_once '/usr/share/php/ramp/model/business/validation/UppercaseAlphanumericStrict.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockUppercaseAlphanumericStrict.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\UppercaseAlphanumericStrict;

use tests\ramp\mocks\model\MockUppercaseAlphanumericStrict;
...
/**
 * Collection of tests for \ramp\model\business\validation\UppercaseAlphanumericStrict.
 */
class UppercaseAlphanumericStrictTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockUppercaseAlphanumericStrict($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\UppercaseAlphanumericStrict.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\UppercaseAlphanumericStrict}
   * @see \ramp\model\business\validation\UppercaseAlphanumericStrict
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\UppercaseAlphanumericStrict', $this->testObject);
  }
  ...
  public function testExpectedAttributeValues()
  {
    ...
    $this->assertEquals('[0-9A-Z]*', (string)$this->testObject->pattern);
  ...
  public function testProcess(
    array $badValues = ['BAD.regex'], ?array $goodValues = ['2G00D2B3'], int $failPoint = 1, int $ruleCount = 6,
