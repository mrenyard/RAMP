...
require_once '/usr/share/php/ramp/model/business/validation/AlphanumericPhrase.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockAlphanumericPhrase.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\AlphanumericPhrase;

use tests\ramp\mocks\model\MockAlphanumericPhrase;
...
/**
 * Collection of tests for \ramp\model\business\validation\AlphanumericPhrase.
 */
class AlphanumericPhraseTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockAlphanumericPhrase($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\AlphanumericPhrase.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\AlphanumericPhrase}
   * @see \ramp\model\business\validation\AlphanumericPhrase
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\AlphanumericPhrase', $this->testObject);
  }
  ...
  public function testExpectedAttributeValues()
  {
    ...
    $this->assertSame('[0-9a-zA-Z_\-\.\'! "£\$%\^\*\(\)\+=\/\:;@~#\?,]*', (string)$this->testObject->pattern);
  ...
  public function testProcess(
    array $badValues = ['<badregex>'],
    ?array $goodValues = ['#g0(d_R£g-ex!?* @:;~ $%-8^'],
    int $failPoint = 1, int $ruleCount = 6,
