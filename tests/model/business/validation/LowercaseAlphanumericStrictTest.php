...
require_once '/usr/share/php/ramp/model/business/validation/LowercaseAlphanumericStrict.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockLowercaseAlphanumericStrict.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\LowercaseAlphanumericStrict;

use tests\ramp\mocks\model\MockLowercaseAlphanumericStrict;
...
/**
 * Collection of tests for \ramp\model\business\validation\LowercaseAlphanumericStrict.
 */
class LowercaseAlphanumericStrictTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockLowercaseAlphanumericStrict($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\LowercaseAlphanumericStrict.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\LowercaseAlphanumericStrict}
   * @see \ramp\model\business\validation\LowercaseAlphanumericStrict
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\LowercaseAlphanumericStrict', $this->testObject);
  }
