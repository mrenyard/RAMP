...
require_once '/usr/share/php/ramp/model/business/validation/PostCode.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockPostCode.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\PostCode;

use tests\ramp\mocks\model\MockPostCode;
...
/**
 * Collection of tests for \ramp\model\business\validation\PostCode.
 */
class PostCodeTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockPostCode($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\PostCode.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\PostCode}
   * @see \ramp\model\business\validation\PostCode
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\PostCode', $this->testObject);
  }
  ...
  public function testProcess(
    array $badValues = ['bad code'], ?array $goodValues = ['SO16 8EL'], int $failPoint = 1, int $ruleCount = 5,
