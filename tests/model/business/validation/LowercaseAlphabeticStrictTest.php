...
require_once '/usr/share/php/ramp/model/business/validation/LowercaseAlphabeticStrict.class.php';

require_once '/usr/share/php/tests/ramp/mocks/model/MockLowercaseAlphabeticStrict.class.php';

use ramp\core\RAMPObject;
use ramp\core\Str;
use ramp\model\business\validation\FailedValidationException;
use ramp\model\business\validation\LowercaseAlphabeticStrict;

use tests\ramp\mocks\model\MockLowercaseAlphabeticStrict;
...
/**
 * Collection of tests for \ramp\model\business\validation\LowercaseAlphabeticStrict.
 */
class LowercaseAlphabeticStrictTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  #[\Override]
  ...
  protected function getTestObject() : RAMPObject {
    return new MockLowercaseAlphabeticStrict($this->hint6,
  ...
  /**
   * Collection of assertions for ramp\validation\LowercaseAlphabeticStrict.
   * - assert is instance of {@see \ramp\core\RAMPObject}
   * - assert is instance of {@see \ramp\model\business\validation\ValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\RegexValidationRule}
   * - assert is instance of {@see \ramp\model\business\validation\LowercaseAlphabeticStrict}
   * @see \ramp\model\business\validation\LowercaseAlphabeticStrict
   */
  #[\Override]
  public function testConstruct() : void
  {
    parent::testConstruct();
    $this->assertInstanceOf('ramp\model\business\validation\LowercaseAlphabeticStrict', $this->testObject);
  }
  ...
  public function testExpectedAttributeValues()
  {
    ...
    $this->assertEquals('[a-z]*', (string)$this->testObject->pattern);
