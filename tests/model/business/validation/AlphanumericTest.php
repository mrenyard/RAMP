...
require_once '/usr/share/php/tests/ramp/mocks/model/MockAlphanumeric.class.php';
...
use tests\ramp\mocks\model\MockAlphanumeric;
 ...
 */
class AlphanumericTest extends \tests\ramp\model\business\validation\RegexValidationRuleTest
{
  #region Setup
  ...
  protected function getTestObject() : RAMPObject {
    return new MockAlphanumeric($this->hint6,
  ...
  public function testProcess(
    array $badValues = ['bad@regex'], ?array $goodValues = ['g0-0d_Re.gex'], int $failPoint = 1, int $ruleCount = 6,
