...
class GB_Addresses extends Record
{
  ...
  protected function get_buildingNumber() : field\Input
  {
    if (!isset($this['buildingNumber']))
    {
      $this['buildingNumber'] = new field\Input(
        ...
        $this,
        new validation\dbtype\smallint(
          Str::set('My error message HERE!')
        )
      );
    }
  ...
  protected function get_postcodeType() : field\Input
  {
    if (!isset($this['postcodeType']))
    {
      $this['postcodeType'] = new field\Input(
        Str::set('postcodeType'),
        $this,
        new validation\dbtype\VarChar(
          1,
          new validation\Alphanumeric(),
  ...
  protected function get_SmallUserOrganisationFLAG() : field\Input
  {
    if (!isset($this['SmallUserOrganisationFLAG']))
    {
      $this['SmallUserOrganisationFLAG'] = new field\Input(
        Str::set('SmallUserOrganisationFLAG'),
        $this,
    ...
    return $this['SmallUserOrganisationFLAG'];
  }
  ...
  protected static function checkRequired($dataObject) : bool
  {
    return (
      ...
      isset($dataObject->postcodeType) &&
      isset($dataObject->SmallUserOrganisationFLAG) &&
