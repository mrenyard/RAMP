...
<?php include("../../head.php"); ?>
  ...
  <body id="<?=str_replace('.', '-', \ramp\SETTING::$RAMP_DOMAIN) ?>" class="content-page">
    <main id="main">
      <header><a href="#main" title="Style Guide and CSS Design Patterns of a RAMP Application">#</a>
...
<?php
$dir =  $_SERVER["DOCUMENT_ROOT"].'/assets/style/img/dynamic/';
chdir($dir);
